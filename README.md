...
This repo is meant contain the code behind alienDB.org (aka "AlienDB"), which is a data and ML-centric website about ET life, UAPs, SETI, METI and the human beings behind the search. The site is only a few weeks old (as of mid August, 2022) so it's incomplete, rapidly eloving, and fairly messy. 
